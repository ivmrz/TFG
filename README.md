SE CONSIDERA QUE SE ESTÁ TRABAJANDO EN UNA TERMINAL DE POWERSHELL WINDOWS EN VISUAL STUDIO CODE
...
IMPORTANTE: PARA ALGUNAS VULNERABILIDADES SE HA TENIDO QUE EJECUTAR "app.py" EN UNA MÁQUINA VIRTUAL CON LINUX (conectada por conexión puente a nuestro pc principal)
